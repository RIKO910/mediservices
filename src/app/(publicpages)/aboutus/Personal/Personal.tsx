...
import riko from '../../../../../public/assets/img/riko.jpeg'
                        ...
                        <figure className="relative isolate pt-6 sm:pt-12">
                            ...
                            <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                                <p>
                                    ...
                                    suscipit tincidunt
                                    nunc. Et non lorem tortor posuere. Nunc eu scelerisque interdum eget tellus non nibh
                                    scelerisque
                                    bibendum.
                                </p>
                            </blockquote>
                            <figcaption className="mt-8 text-base">
                                <div className="font-semibold text-white">Mr. Riko</div>
                                <div className="mt-1 text-gray-400">CEO of MediServices</div>
                            </figcaption>
                        </figure>
                    </div>
                </div>
